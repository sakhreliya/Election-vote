...
import logo from './User/User-tool/image/Vote.png'
import formlogo from './User/User-tool/image/Vote.png'
        ...
        <>
            <div className='row user-login'>
                <div className='col-6 l-1 e-logo'>
                    <img src={logo} className='w-25' alt='Vote' />
                </div>
                <div className='col-6 e-form e-logo'>
                    <div className='form'>
                        ...
                        <button className="btn w-100 btn-secondary" onClick={handleLogin}>Log In</button>
