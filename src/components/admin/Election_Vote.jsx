          ...
          <div className='col-8'>
            <div className="container-p">
              <div className=" d-flex ">
                ...
                <div className="col-6 box-sh shadow-sm">
                  <h4 className='vote-text-set'>Party in Election</h4>
                ...
                <div className="calling">
                  <table style={{ transform: "scale(0.9)" }} className="table ">
                    <tr>
                      ...
                      <th className='thead border border-1 border-dark' scope="col">Election_Party_Name</th>
                      <th className='thead border border-1 border-dark' scope="col">Election_Party_Vote</th>
                    </tr>
                    <tbody>
