            ...
            <div className="container-p">
              <table style={{ transform: "scale(0.9)" }} className="table">
                <tr>
                  ...
                  <th className='thead border border-1 border-dark' scope="col">Party_Name</th>
                  <th className='thead border border-1 border-dark' scope="col">Party_Logo</th>
                  <th className='thead border border-1 border-dark' scope="col">Party_Short_Code</th>
        ...
        <div className="modal-dialog modal-dialog-centered" >
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5 " id="exampleModalLabel">Create Election Party</h1>
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-3 mt-2 ">
                  <input
                    ...
                    placeholder="Election Party Name"
                    name="party_name"
