...
import side_logo from "./admin-tool/img/Vote.png";
import Admin_logo from "./admin-tool/img/Avtar.png";
...
function Navbar() {
  ...
  const handleLogout = () => {
    MySwal.fire({
      title: 'You are confrom to logout?',
      icon: 'warning',
    ...
    <nav style={{ height: "81px" }} className="navbar admin-navbar navbar-expand-lg w-100 navbar-dark">
      <div className="container">
        <a className="navbar-brand" href="#">
          <img src={side_logo} alt="Logo" width="200" height="80" className="d-inline-block align-text-top" />
        </a>
